...
char namearray[NODE_COUNT][10] = {"GPS01", "Bridge02", "Relay03", "Relay04", "Temp05", "Sound06", "PIR07"};
...
void initProperties()
{
  ...
  std::strcpy(namearray[Bridge02], "Bridge02");
  std::strcpy(namearray[Relay03], "Relay03");
  std::strcpy(namearray[Relay04], "Relay04");
